...
stewart = StewartPlatform(0, r_B=20, r_P=15, gamma_B_deg=25.25, gamma_P_deg=21.85, serial_port=None, controller_type='DSTA', base_offset=[0, 0, 0])
time.sleep(3)
...
positions, orientations, positions2, orientations2 = trajectory_generator.generate_trajectory2(steps, dt, stewart, stewart)
